...
## Pushbuttons
# SW3 top
set_property PACKAGE_PIN P6 [get_ports load]
set_property IOSTANDARD LVCMOS15 [get_ports load]
#SW 7 left
set_property PACKAGE_PIN R5 [get_ports direction]
set_property IOSTANDARD SSTL15 [get_ports direction]
#SW 6 center
set_property PACKAGE_PIN U6 [get_ports ent]
set_property IOSTANDARD SSTL15 [get_ports ent]
# SW 4 right
set_property PACKAGE_PIN U5 [get_ports enp]
set_property IOSTANDARD SSTL15 [get_ports enp]
#set_property PACKAGE_PIN T5 [get_ports pushbuttons[4]]
#set_property IOSTANDARD SSTL15 [get_ports pushbuttons[4]]

## DIP switches
set_property PACKAGE_PIN R8 [get_ports number_for_load[0]]
set_property IOSTANDARD SSTL15 [get_ports number_for_load[0]]
set_property PACKAGE_PIN P8 [get_ports number_for_load[1]]
set_property IOSTANDARD SSTL15 [get_ports number_for_load[1]]
set_property PACKAGE_PIN R7 [get_ports number_for_load[2]]
set_property IOSTANDARD SSTL15 [get_ports number_for_load[2]]
set_property PACKAGE_PIN R6 [get_ports number_for_load[3]]
set_property IOSTANDARD SSTL15 [get_ports number_for_load[3]]
