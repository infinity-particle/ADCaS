...
set_property PACKAGE_PIN M26 [get_ports result[0]]
set_property IOSTANDARD LVCMOS33 [get_ports result[0]]
set_property PACKAGE_PIN T24 [get_ports result[1]]
set_property IOSTANDARD LVCMOS33 [get_ports result[1]]
set_property PACKAGE_PIN T25 [get_ports result[2]]
set_property IOSTANDARD LVCMOS33 [get_ports result[2]]
set_property PACKAGE_PIN R26 [get_ports result[3]]
...
## Pushbuttons
set_property PACKAGE_PIN P6 [get_ports direction]
set_property IOSTANDARD LVCMOS15 [get_ports direction]
set_property PACKAGE_PIN R5 [get_ports ent]
...
## DIP switches
set_property PACKAGE_PIN R8 [get_ports data[0]]
set_property IOSTANDARD SSTL15 [get_ports data[0]]
set_property PACKAGE_PIN P8 [get_ports data[1]]
set_property IOSTANDARD SSTL15 [get_ports data[1]]
set_property PACKAGE_PIN R7 [get_ports data[2]]
set_property IOSTANDARD SSTL15 [get_ports data[2]]
set_property PACKAGE_PIN R6 [get_ports data[3]]
set_property IOSTANDARD SSTL15 [get_ports data[3]]
